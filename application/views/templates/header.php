...
<head>
    ...
    <title><?= $title; ?></title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url(); ?>assets/images/ieg.png">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?= base_url('dashboard') ?>" class="brand-logo">
                <img class="logo-abbr" src="<?= base_url(); ?>assets/images/amikom.png" alt="">
              <h2  style="font-family:Verdana, Geneva, Tahoma, sans-serif; margin-left:10%" >Presensi</h2>
            </a>
